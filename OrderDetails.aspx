<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OrderDetails.aspx.cs" Inherits="KrishiSadhana.OrderDetails" %>
            ...
            <div class="d-flex">
                ...
                <div class="main-content w-100">
                    ...
                    <div class="form-section">
                        ...
                        <asp:GridView ID="OrderDetailsGrid" runat="server" AutoGenerateColumns="False" Height="201px" Width="776px"
                            CssClass="gridViewStyle" BorderColor="Silver" BorderWidth="1px" GridLines="Horizontal" CellPadding="10">
                            <Columns>

                                <asp:TemplateField HeaderText="Product Image">
                                    <ItemTemplate>
                                        <asp:Image ID="imgProduct" runat="server" ImageUrl='<%# Eval("Image") %>' Width="60px" Height="60px" />
                                    </ItemTemplate>
