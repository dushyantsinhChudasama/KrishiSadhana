<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vehicles.aspx.cs" Inherits="KrishiSadhana.Administrator.Vehicles" %>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="d-flex">
            <div class="sidebar d-flex flex-column p-3">
                ...
                <a href="Vehicles.aspx" class="active">Vehicles</a>
                ...
                <div class="row">
                    <div class="col-lg-12 ms-auto p-4 overflow-hidden">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <h3 class="mb-4" style="font-weight: 500;">All Vehicles</h3>
                        ...
                        <div class="card border-0 shadow mb-4" style="width: 1200px; height: 490px; left: 0px; top: 0px;">
                            <div>
                                ...
                                <div style="width: 1150px; height: 380px; overflow: auto; border: 1px solid silver; margin: 20px; margin-bottom: 10px;">
                                    ...
                                    <asp:GridView ID="VehicleGrid" CellPadding="10" runat="server" AutoGenerateColumns="False" Height="460px" Width="1150px" BorderColor="Silver"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Image">
                                                <ItemTemplate>
                                                    <asp:Image ID="Image1" runat="server" Height="59px" ImageUrl='<%# ResolveUrl("~/Images/Vehicle_Image/" + Eval("Image").ToString().Split("/"[0]).Last()) %>' Width="66px" />
                                            ...
                                            <asp:TemplateField HeaderText="Rent Per Day">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("Rent_Per_Day") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="DateAdd">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("DateAdded") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:TemplateField>
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalLabel">Add New Vehicle</h5>
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtCompany" CssClass="form-control" Placeholder="Enter Company" runat="server" />
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtProduct" CssClass="form-control" Placeholder="Enter Products of Vehicle" runat="server" />
                                            </div>
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtRent" CssClass="form-control" Placeholder="Enter Rent Per Day" runat="server" />
                                            </div>
                                        </div>
