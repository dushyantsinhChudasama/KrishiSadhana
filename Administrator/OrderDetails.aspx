<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetails.aspx.cs" Inherits="KrishiSadhana.Administrator.OrderDetails" %>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <asp:TextBox ID="txtEmail" CssClass="form-control" Placeholder="Enter name" runat="server" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-1">Customer Phone</div>
                                                <asp:TextBox ID="txtPhone" CssClass="form-control" Placeholder="Enter Total Quantity" runat="server" />
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-1">Customer Pincode</div>
                                                <asp:TextBox ID="txtPincode" CssClass="form-control" Placeholder="Enter Product Origin" runat="server" />
                                            </div>
                                        </div>

                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <div class="mb-1">Order_ID</div>
                                                <asp:TextBox ID="txtOrderId" CssClass="form-control" AutoPostBack="true" Placeholder="Enter Original Price" runat="server" />
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-1">Payment_ID</div>
                                                <asp:TextBox ID="txtPaymentId" CssClass="form-control" AutoPostBack="true" Placeholder="Enter Selling Price" runat="server" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox ID="txtaddress" CssClass="form-control" Placeholder="Enter Product Slug" runat="server" />
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-1">Customer Landmark</div>
                                                <asp:TextBox ID="txtLandmark" Enabled="false" CssClass="form-control"  runat="server" />
                                            </div>

                                             <div class="col-md-4">
                                                <div class="mb-1">Customer Note</div>
                                                <asp:TextBox ID="txtNote" Enabled="false"  CssClass="form-control"  runat="server" />
                                            </div>

                                             <div class="col-md-4">
                                                <div class="mb-1">Total Amount</div>
                                                <asp:TextBox ID="txtTotalAmount" Enabled="false" CssClass="form-control"  runat="server" />
                                            </div>
