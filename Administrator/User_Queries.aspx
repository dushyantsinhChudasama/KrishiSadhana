<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Queries.aspx.cs" Inherits="KrishiSadhana.Administrator.User_Queries" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="d-flex">
            <div class="sidebar d-flex flex-column p-3">
                ...
                <a href="User_Queries.aspx" class="active">User Queries</a>
                        ...
                        <div class="card border-0 shadow mb-4" style="width: 1116px; height: 440px; left: 0px; top: 0px;">
                            <div>
                                <div class="d-flex justify-content-end mb-4 mt-4 me-3">
                                    <asp:Button ID="btnAllRecords" CssClass="btn btn-dark shadow-none btn-sm" runat="server" Text="Button" />
                                </div>
                                ...
                                <div style="width: 1000px; height: 340px; overflow: auto; border: 1px solid silver; margin: 20px; margin-bottom: 10px;">
                                    ...
                                    <asp:GridView ID="UserQueriesGrid" CellPadding="10"  runat="server" AutoGenerateColumns="False" Height="400px" Width="978px" BorderColor="Silver"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name">
                                             ...
                                             <asp:TemplateField HeaderText="Date">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label7" runat="server" Text='<%# Eval("DateAdded") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="600px" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LinkButton1" CssClass="btn btn-sm rounded-pill btn-primary text-white" runat="server" CommandArgument='<%# Eval("Id") %>' CommandName="cmd_dlt" ForeColor="Red">Mark as Read
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="600px" />
