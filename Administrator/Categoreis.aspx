                            ...
                            <div>
                                ...
                                <div style="width: 1000px; height: 340px; overflow: auto; border: 1px solid silver; margin:20px;margin-bottom:10px;">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridViewStyle"
                                        CellPadding="10" Width="969px" HorizontalAlign="Center" BorderColor="Silver"
                                        BorderWidth="1px" GridLines="Horizontal" OnRowCommand="GridView1_RowCommand">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Id">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                <ItemStyle Width="4px" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandName="cmd_dlt" 
                                                        ImageUrl="~/assets/Images/icons8-delete-100.png" CssClass="deleteButton"
                                                        Height="31px" ImageAlign="AbsMiddle" Width="35px" />
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />
