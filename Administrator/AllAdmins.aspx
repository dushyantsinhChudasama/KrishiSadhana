<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllAdmins.aspx.cs" Inherits="KrishiSadhana.Administrator.AllAdmins" %>
 ...
 <form id="form1" runat="server">
        ...
        <div class="d-flex">
            <div class="sidebar d-flex flex-column p-3">
                ...
                <a href="AllAdmins.aspx"  class="active">Admins</a>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 ms-auto p-4 overflow-hidden">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <h3 class="mb-4" style="font-weight: 500;">All Admins</h3>
                        ...
                        <div class="card border-0 shadow mb-4" style="width: 1050px; height: 440px">
                            <div>
                               ...
                               <div style="width: 1000px; height: 340px; overflow: auto; border: 1px solid silver; margin: 20px; margin-bottom: 10px;">
                                    ...
                                    <asp:GridView ID="AdminGrid" CellPadding="10"  runat="server" AutoGenerateColumns="False" Height="400px" Width="980px" BorderColor="Silver"
                                        BorderWidth="1px" GridLines="Horizontal" CssClass="gridViewStyle" OnRowCommand="AdminGrid_RowCommand" PageSize="500">
                                        <Columns>
                ...
                <ContentTemplate>
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <!-- Second Row for Password and Confirm Password -->
                            <div class="row mb-4">
                                <div class="col-md-6">
