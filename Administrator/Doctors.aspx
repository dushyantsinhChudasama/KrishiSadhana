<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Doctors.aspx.cs" Inherits="KrishiSadhana.Administrator.Doctors" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 ms-auto p-4 overflow-hidden">
                        <h3 class="mb-4" style="font-weight: 500">All Doctors</h3>
                        <div class="card border-0 shadow mb-4" style="width: 1200px; height: 490px; left: 0px; top: 0px;">
                            <div>
                                ...
                                <div style="width: 1150px; height: 380px; overflow: auto; border: 1px solid silver; margin: 20px; margin-bottom: 10px;">
                                    ...
                                    <asp:GridView ID="ProductGrid" CellPadding="10" runat="server" AutoGenerateColumns="False" Height="460px" Width="1125px" BorderColor="Silver"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Image">
                                                <ItemTemplate>
                                                    <asp:Image ID="Image1" runat="server" Height="59px" ImageUrl='<%# ResolveUrl("~/Images/Doctor_Images/" + Eval("Image").ToString().Split("/"[0]).Last()) %>' Width="66px" />
                                            ...
                                            <asp:TemplateField HeaderText="Experience">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("Current_experience") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Study">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("Study") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Speciality">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("Specialization") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImageButton1" runat="server" CommandArgument='<%# Eval("Id") %>' CommandName="cmd_edt" Height="37px" ImageUrl="~/assets/Images/editIcon.png" Width="38px" CausesValidation="false"/>
                                                    &nbsp;&nbsp;
                                                    <asp:ImageButton ID="ImageButton2" runat="server" CommandArgument='<%# Eval("Id") %>' CommandName="cmd_dlt" Height="37px" ImageUrl="~/assets/Images/deleteIcon.png" Width="38px" CausesValidation="false"/>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="sticky-header" BackColor="#212529" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" Width="100px" />
                                            </asp:TemplateField>
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtExperience" CssClass="form-control" Placeholder="Enter Experience" runat="server" />
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtSpeciality" CssClass="form-control" Placeholder="Enter Specialization of doctor" runat="server" />
                                            </div>
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtStudy" CssClass="form-control" Placeholder="Enter Highest Qualification" runat="server" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                                <asp:TextBox ID="txtState" CssClass="form-control" Placeholder="Enter State" runat="server" />
