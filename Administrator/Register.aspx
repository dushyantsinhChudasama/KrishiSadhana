<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="KrishiSadhana.Administrator.Register" %>
        ...
        <div>
            <div class="login-form text-center rounded bg-white shadow overflow-hidden">
                <form method="POST">
                    ...
                    <div class="p-4">
                         <div class="mb-3">
                            <asp:TextBox ID="txtName" runat="server" class="form-control shadow-none text-center" placeholder="Admin User Name"></asp:TextBox>
                            <%--<input name="admin_name" required type="text" ">--%>
                        </div>
                        <div class="mb-3">
                            <asp:TextBox ID="txtEmail" runat="server" class="form-control shadow-none text-center" placeholder="Admin Email"></asp:TextBox>
                            <%--<input name="admin_name" required type="text" ">--%>
                        </div>
                        <div class="mb-3">
