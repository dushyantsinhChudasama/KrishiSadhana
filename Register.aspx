<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="KrishiSadhana.Register" %>
    ...
    <div class="wrapper bg-light">
        <div class="register-container">
            ...
            <div class="input-row">
                ...
                <asp:TextBox ID="txtName" placeholder="Enter name" CssClass="input-field" runat="server"></asp:TextBox>
                <asp:TextBox ID="txtEmail" placeholder="Enter Email" CssClass="input-field" runat="server"></asp:TextBox>

            </div>
            <div class="input-row">

                <asp:TextBox ID="txtMobile" placeholder="Enter Mobile" CssClass="input-field" runat="server"></asp:TextBox>
                <asp:RadioButtonList ID="rbGen" CssClass="input-field radio-margin" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Value="Male" style="margin-right: 10px;"></asp:ListItem>
            ...
            <div class="input-row">
                ...
                <asp:TextBox ID="txtPwd" placeholder="Enter Password" CssClass="input-field" runat="server"></asp:TextBox>
                <asp:TextBox ID="txtCPwd" placeholder="Enter Confirm Password" CssClass="input-field" runat="server"></asp:TextBox>

            </div>
            <asp:Button ID="btnRegister" CssClass="login-btn" runat="server" Text="Register" OnClick="btnRegister_Click" />
            <p class="register-text">Already have an account? <a href="Login.aspx">Login</a></p>
            <p class="register-text">Clcik for <a href="Admin.aspx">Admin Login</a></p>
        </div>
    </div>
    ...
    <body>
        ...
        <header class="main-header">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                <a href="Home.aspx">
                    <img src="assets/Images/Logo.png" style="width: 160px; height: 70px;"
                        alt="KrishiSadhana"></a>
                ...
                <div class="header-icons">
                    ...
                    <a href="#" class="icons text-secondary">
